  ...
  HospitalMarker({
    ...
    required Hospital hospital,
          ...
          icon: NOverlayImage.fromAssetImage(
              hospital.hasER ? Assets.emergency : Assets.hospital),
        ) {
    if (hospital.hasER) {
      setZIndex(300000);
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    height: 3,
                    color:
                        hospital.hasER ? Colors.redAccent : Colors.lightGreen,
                  ),
                  const Text(
                    "시간표",
                    style: TextStyle(
                  ...
                  Center(
                    child: Table(
                      ...
                      children: [
                        TableRow(children: [
                          text("월요일"),
                          text(hospital.timeMon),
                        ]),
                        TableRow(children: [
                          text("화요일"),
                          text(hospital.timeTue),
                        ]),
                        TableRow(children: [
                          text("수요일"),
                          text(hospital.timeWen),
                        ]),
                        TableRow(children: [
                          text("목요일"),
                          text(hospital.timeThu),
                        ]),
                        TableRow(children: [
                          text("금요일"),
                          text(hospital.timeFri),
                        ]),
                        TableRow(children: [
                          text("토요일"),
                          text(hospital.timeSat),
                        ]),
                        TableRow(children: [
                          text("일요일"),
                          text(hospital.timeSun),
                        ]),
                      ],
                    ),
                  ),
